    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group row">
                    <label for="" class="col-sm-4 col-form-label">Shift</label>
                    <div class="col-sm-8">
                        <select name="shift" id="shift" class="form-control" style="font-size: 13px;">
                            <option value="">Pilih Shift</option>
                            <option value="1">SHIFT 1</option>
                            <option value="2">SHIFT 2</option>
                            <option value="3">SHIFT 3</option>
                        </select>
                        <div class="invalid-feedback errorShift" style="display: none;"></div>
                    </div>
                </div>
                <div class="form-group row">
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.error) {
                        ...
                        if (response.error.errorShift) {
                            $('.errorShift').html(response.error.errorShift).show();
                            $('#shift').addClass('is-invalid');
                        } else {
                            $('.errorShift').fadeOut();
                            $('#shift').removeClass('is-invalid');
                            $('#shift').addClass('is-valid');
                        }
                    } else {
                        Swal.fire({
                            icon: 'success',

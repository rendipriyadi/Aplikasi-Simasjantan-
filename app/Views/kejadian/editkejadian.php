...
<ol class="breadcrumb float-sm-right">
    ...
    <li class="breadcrumb-item active">Edit Kejadian</li>
</ol>
<?= $this->endSection() ?>

<?= $this->section('detail') ?>
<i class="fa fa-tasks"> Edit Data Kejadian</i>
<?= $this->endSection() ?>
...
<div class="form-group row">
    ...
    <div class="col-sm-2">
        <button type="button" class="btn btn-info tombolStatus" id="tombolUpdateStatus">Update Status</button>
    </div>
</div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-sm-7">
                                <select name="cuaca" id="cuaca" class="form-control" style="font-size: 13px;">
                                    <option value="CERAH" <?php if ($cuaca == 'CERAH') echo "selected"; ?>>CERAH</option>
                                    <option value="GERIMIS" <?php if ($cuaca == 'GERIMIS') echo "selected"; ?>>GERIMIS</option>
                                    <option value="HUJAN" <?php if ($cuaca == 'HUJAN') echo "selected"; ?>>HUJAN</option>
                                    <option value="MENDUNG" <?php if ($cuaca == 'MENDUNG') echo "selected"; ?>>MENDUNG</option>
                                </select>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-sm-7">
                                <select name="harilibur" id="harilibur" class="form-control" style="font-size: 13px;">
                                    <option value="HARI KERJA" <?php if ($harilibur == 'HARI KERJA') echo "selected"; ?>>HARI KERJA</option>
                                    <option value="HARI LIBUR" <?php if ($harilibur == 'HARI LIBUR') echo "selected"; ?>>HARI LIBUR</option>
                                </select>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="form-group col-sm-3">
                                <?php foreach ($datasta as $row) : ?>
                                    <?php if ($row['id_sta'] == $sta) : ?>
                                        <input type="text" class="form-control" id="sta" name="sta" value="<?= $row['kode_lokasi'] ?>">
                                    <?php endif; ?>
                                <?php endforeach; ?>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-lg-4 col-md-3">
                                <select name="lajur" id="lajur" class="form-control">
                                    <option value="LAJUR 1" <?php if ($lajur == 'LAJUR 1') echo "selected"; ?>>LAJUR 1</option>
                                    <option value="LAJUR 2" <?php if ($lajur == 'LAJUR 2') echo "selected"; ?>>LAJUR 2</option>
                                    <option value="LAJUR 3" <?php if ($lajur == 'LAJUR 3') echo "selected"; ?>>LAJUR 3</option>
                                </select>
                            </div>
                            ...
                            <div class="form-group col-lg-4 col-md-3">
                                <select name="lalulintas" id="lalulintas" class="form-control" style="font-size: 13px;">
                                    <option value="LANCAR" <?php if ($lalulintas == 'LANCAR') echo "selected"; ?>>LANCAR</option>
                                    <option value="RAMAI LANCAR" <?php if ($lalulintas == 'RAMAI LANCAR') echo "selected"; ?>>RAMAI LANCAR</option>
                                    <option value="PADAT" <?php if ($lalulintas == 'PADAT') echo "selected"; ?>>PADAT</option>
                                </select>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="tab-content" id="nav-tabContent">
                            <div class="tab-pane fade show active" id="detail" role="tabpanel">
                                <div class="form-row form1">
                                        ...
                                        <select name="penyebab" id="penyebab" class="form-control">
                                            <?php foreach ($penyebabTab as $row) : ?>
                                                ` <?php if ($row['id_penyebab'] == $penyebab) : ?>
                                                    <option selected value="<?= $row['id_penyebab'] ?>"><?= $row['deskripsi_penyebab'] ?></option>
                                                <?php else : ?>
                                    ...
                                    <div class="form-group col-sm-4">
                                        <select name="posisi" id="posisi" class="form-control" style="font-size: 13px;">
                                            <option value="MENYEBRANG" <?php if ($posisi == 'MENYEBRANG') echo "selected"; ?>>MENYEBRANG</option>
                                            <option value="TIDAK MENYEBRANG" <?php if ($posisi == 'TIDAK MENYEBRANG') echo "selected"; ?>>TIDAK MENYEBRANG</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-row form2">
                                    ...
                                    <div class="form-group col-sm-4">
                                        <select name="lokasi" id="lokasi" class="form-control">
                                            <option value="DAERAH GERBANG" <?php if ($lokasi == 'DAERAH GERBANG') echo "selected"; ?>>DAERAH GERBANG</option>
                                            <option value="INTERCHANGE" <?php if ($lokasi == 'INTERCHANGE') echo "selected"; ?>>INTERCHANGE</option>
                                            <option value="JALAN UTAMA" <?php if ($lokasi == 'JALAN UTAMA') echo "selected"; ?>>JALAN UTAMA</option>
                                            <option value="JALAN AKSES" <?php if ($lokasi == 'JALAN AKSES') echo "selected"; ?>>JALAN AKSES</option>
                                            <option value="JEMBATAN" <?php if ($lokasi == 'JEMBATAN') echo "selected"; ?>>JEMBATAN</option>
                                            <option value="RAMP" <?php if ($lokasi == 'RAMP') echo "selected"; ?>>RAMP</option>
                                            <option value="LOKASI LAINYA" <?php if ($lokasi == 'LOKASI LAINYA') echo "selected"; ?>>LOKASI LAINYA</option>
                                        </select>
                                    </div>
                                        ...
                                        <select name="tipeTabrakan" id="tipeTabrakan" class="form-control">
                                            <?php foreach ($tipeTab as $row) : ?>
                                                ` <?php if ($row['id_tipe_tabrakan'] == $tipetabrakan) : ?>
                                                    <option selected value="<?= $row['id_tipe_tabrakan'] ?>"><?= $row['deskripsi_tipe'] ?></option>
                                                <?php else : ?>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-sm-10">
                                        <textarea name="keterangan" id="keterangan" class="form-control" rows="5" style="font-size: 13px;"><?= $keterangan ?></textarea>
                                    </div>
                                </div>
                                <div class="form-row">
                                ...
                                <div class="form-row">
                                    <label for="" class="col-sm-2">Ganti Rekaman CCTV :</label>
                                    <div class="form-group col-sm-4">
                            ...
                            <div id="korban" class="tab-pane fade" role="tabpanel">
                                <div class="form-row">
                                    <div class="card col-sm-12">
                                        <div class="card-body">
                                            <button type="button" class="btn btn-info" id="tombolKorban"><i class="fa fa-plus-circle"> Korban Kecelakaan</i></button>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div id="mobilkorban" class="tab-pane fade" role="tabpanel">
                                <div class="form-row">
                                    <div class="card col-sm-12">
                                        <div class="card-body">
                                            <button type="button" class="btn btn-info" id="tombolMobilKorban"><i class="fa fa-plus-circle"> Mobil Terlibat</i></button>
                                        </div>
                                    </div>
                                </div>
...
<div class="form-row tombolAksi">
    <div class="col-sm-4">
    </div>
    <div class="col-sm-6 offset-1">
        <button type="submit" class="btn btn-success tombolUpdate">Update</button>
        <button type="button" class="btn btn-warning" onclick="window.location='<?= site_url('kejadian/index') ?>'">Kembali</button>
    </div>
</div>
<?= form_close(); ?>

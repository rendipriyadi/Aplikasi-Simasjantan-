<!-- Modal -->
<div class="modal fade" id="modaleditstatus" aria-labelledby="modaleditstatusLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <?= form_open('kejadian/updatestatus', ['class' => 'formeditstatus']) ?>
      <?php csrf_field(); ?>
      <div class="modal-body">
          <input type="hidden" name="idstatus" id="idstatus" class="form-control" value="<?= $idstatus ?>">
      ...
      <div class="modal-footer">
        <button type="submit" class="btn btn-outline-success tombolEditStatus">Simpan</button>
...
$(document).ready(function () {
    ...
    $('.formeditstatus').submit(function (e) {
        ...
        $.ajax({
            ...
            dataType: "json",
            beforeSend: function () {
                $('.tombolEditStatus').prop('disabled', true);
                $('.tombolEditStatus').html('<i class="fas fa-spinner fa-spin"></i>');
            },
            complete: function () {
                $('.tombolEditStatus').html('Simpan');
                $('.tombolEditStatus').prop('disabled', false);
            },

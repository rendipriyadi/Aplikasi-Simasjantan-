<div class="modal fade" id="modallaporanterkait" tabindex="-1" aria-labelledby="modallaporanterkaitLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="card">
          <input type="hidden" class="form-control" id="idkejadianlaporan" name="idkejadianlaporan" value="<?= $idkejadian ?>">
          <div class="card-body">
            <div class="form-row">
            ...
            <div class="table-responsive">
              <table id="datalaporanterkait" class="table table-bordered table-sm table-striped" width="100%">
                <thead align="center">
                  <tr>
                    <th>No</th>
                    <th>Aksi</th>
...
<script>
  function listDataLaporan() {
    var table = $('#datalaporanterkait').DataTable({
      destroy: true,
      "processing": true,
      "serverSide": true,
      "order": [],
  ...
  function pilih(idlaporanterkait) {
    $('#idlaporanterkait').val(idlaporanterkait);
    $('#modallaporanterkait').on('hidden.bs.modal', function(event) {
      tampilDataLaporan();
    });

    $('#modallaporanterkait').modal('hide');
  }
</script>
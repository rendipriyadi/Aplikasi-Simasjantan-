<!-- Modal -->
<div class="modal fade" id="modaleditgangguan" tabindex="-1" aria-labelledby="modaleditgangguanLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Edit Data Gangguan</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <?= form_open('gangguan/updatedata', ['class' => 'formtambah']) ?>
      <?php csrf_field(); ?>

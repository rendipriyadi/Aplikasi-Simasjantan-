<!-- Modal -->
<div class="modal fade" id="modaltambahgangguan" tabindex="-1" aria-labelledby="modaltambahgangguanLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Tambah Data Gangguan</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <?= form_open('gangguan/simpandata', ['class' => 'formtambah']) ?>
      <?php csrf_field(); ?>

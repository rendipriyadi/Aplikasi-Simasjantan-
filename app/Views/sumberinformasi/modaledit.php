<!-- Modal -->
<div class="modal fade" id="modaleditinformasi" tabindex="-1" aria-labelledby="modaleditinformasiLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Edit Data Sumber Informasi</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <?= form_open('sumberinformasi/updatedata', ['class' => 'formtambah']) ?>
            <?php csrf_field(); ?>
